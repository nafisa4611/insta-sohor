              ...
              <div class="post__header">
                <div class="post__profile">
                  <a
                    ...
                    class="post__avatar"
                  >
                    <img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80%22%20alt=%22User%20Pictures" alt="User Picture" />
                  </a>
              ...
              <div class="post__footer">
                <div class="post__buttons">
                  ...
                  <button class="post__button post__button--align-right" onclick="reportPost(${
                      post.id})">
                    <i class="fa-solid fa-ban ${post.id}"></i>
                  </button>
                </div>
